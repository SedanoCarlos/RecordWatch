...
public class CopiaSeguridad extends AppCompatActivity {
    ...
    public void exportDatabase(View view) {
        ...
        File archivoBD = new File("/data/data/com.recordwatch.recordwatch/databases/RecordWatch");
        File archivoBD2 = new File("/data/data/com.recordwatch.recordwatch/databases/RecordWatch");
